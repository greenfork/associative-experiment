...
require_relative 'locale_helper.rb'
...
module Research
  class Application < Hanami::Application
    configure do
      ...
      #
      sessions :cookie, secret: ENV['RESEARCH_SESSIONS_SECRET']
      ...
      #
      layout :application # It will load Research::Views::ApplicationLayout
      ...
      # Configure the code that will yield each time Research::Action is included
      ...
      # Configure the code that will yield each time Research::View is included
      # This is useful for sharing common functionality
      #
      # See: http://www.rubydoc.info/gems/hanami-view#Configuration
      view.prepare do
        include Hanami::Helpers
        include Research::Assets::Helpers
